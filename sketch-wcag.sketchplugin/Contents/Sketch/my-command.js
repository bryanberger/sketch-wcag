...
exports['default'] = function (context) {
  ...
  var documentObj = context.document;
  ...
  iterator = function () {
    function iterator(layer) {
      ...
      if (layer.isShape) {
        var fillColor = layerObj.style().fills().firstObject().color().NSColorWithColorSpace(nil).hexValue().toString();
  ...
  if (selection) {
    ...
    if (colors.length > 1) {
      var results = colorable(colors, { compact: false, threshold: 0 });
      var html = createHTML(results);
      var file = createFile(html);
...
createHTML = function createHTML(result) {
  var markup = table = '';
  ...
  for (var i = 0; i < result.length; i++) {
    var textColor = isDark(result[i].values.rgb) ? '#fff' : '#000';
    var aaStr = aaLargeStr = aaaStr = aaaLargeStr = '';
    ...
    if (aaStr == '' && aaLargeStr == '' && aaaStr == '' && aaaLargeStr == '') {
      ...
      table = '\n        <tr>\n          <th>AA Large</th>\n          <th>AA</th>\n          <th>AAA Large</th>\n          <th>AAA</th>\n        </tr>\n        <tr>\n          <td>' + String(aaLargeStr) + '</td>\n          <td>' + String(aaStr) + '</td>\n          <td>' + String(aaaLargeStr) + '</td>\n          <td>' + String(aaaStr) + '</td>\n        </tr>\n      ';
    }

    // Wrap
    markup += '\n      <div class="strip" style="color: ' + textColor + '; background-color: ' + String(result[i].hex) + ';"\n        <small>' + String(result[i].hex) + '</small>\n        <table style="color: ' + textColor + ';">\n          ' + String(table) + '\n        </table>\n      </div>\n    ';
  } // end first loop

  return header + markup;
};

createColorBadge = function createColorBadge(resultObj, x) {
  return '\n    <div class="badge" style="color: ' + String(resultObj.hex) + '; background-color: ' + String(resultObj.combinations[x].hex) + '">\n      ' + String(resultObj.combinations[x].hex) + '\n    </div>\n  ';
};

createEmptyBadge = function createEmptyBadge() {
  return '\n    <div class="badge">\n      &nbsp;\n    </div>\n  ';
};
